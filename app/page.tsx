    ...
    <>
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#111]/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center">
          {/* Logo */}
          <div>
            <img src="/logo.png" alt="Veyber" className="h-6 sm:h-7" style={{ filter: "brightness(0) invert(1)" }} />
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 pb-10 sm:pb-14 border-b border-white/8">
            ...
            <div className="col-span-2 sm:col-span-2 md:col-span-1 space-y-4">
              <div>
                ...
                <div className="text-white/25 text-[10px] tracking-widest uppercase mt-1">Services Pvt Ltd</div>
              </div>
      ...
      >
        ...
        <span
          className="relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full shadow-lg transition-transform duration-300 group-hover:scale-110 group-active:scale-95"
